...
*-------------------------------------------------------------------*/
import Vue from 'vue'
Vue.prototype.$reindeerSchemaCDDSnippet = (modelObj) => {
var modelUri=modelObj["uri"];
var model={
    validate: true,
    schemas: [{
        uri: "https://reindeer.tech/cdd-schema/v1/snippet-schema.json", // id of the first schema
        fileMatch: [modelUri.toString()], // associate with our model
        schema: {
            title: modelObj["i18n"]("cddSnippet.t"),
            description: modelObj["i18n"]("cddSnippet.d"),
            type: "object",
            required: ["components"],
            properties: {
                components: {
